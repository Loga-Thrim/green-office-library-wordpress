<?php
/**
 * Template Name: Green Library Results (ผลการดำเนินงาน)
 * Template for Green Library Performance Results by Year
 * 
...
// Validate category number (1-9)
if ($category_num < 1 || $category_num > 9) {
    $category_num = 1;
}
...
// Get HTML content from customizer (format: green_library_year_2568_category_1_content)
$content_key = "green_library_year_{$year}_category_{$category_num}_content";
...
<div class="green-library-category-page">
    ...
    <section class="category-tabs-section">
        <div class="category-tabs-container">
            <nav class="category-tabs category-tabs-9">
                <?php for ($i = 1; $i <= 9; $i++) : ?>
        ...
        <div class="category-content-container">
            ...
            <?php else : ?>
                <div class="no-content-message">
                    ...
                    <p class="small-text">กรุณาเพิ่มเนื้อหาใน Appearance → Customize → Green Library Results (ปี <?php echo $year; ?>)</p>
                </div>
            <?php endif; ?>
        </div>
    </section>
